...
MODEL_DIR = "saved_models/tomek"

def load_data():
    X_train = pd.read_csv("dataset/tomek_resample/X_train.csv").values
    y_train = pd.read_csv("dataset/tomek_resample/y_train.csv").values.ravel()
